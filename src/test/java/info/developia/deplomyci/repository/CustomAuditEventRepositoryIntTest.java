package info.developia.deplomyci.repository;

import info.developia.deplomyci.DeplomyciApp;
import info.developia.deplomyci.config.Constants;
import info.developia.deplomyci.config.audit.AuditEventConverter;
import info.developia.deplomyci.domain.PersistentAuditEvent;
...
import static info.developia.deplomyci.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
